...
const handleLogin = async ()=>{
   ...
   try {
    ...
    behavior={Platform.OS === "ios" ? "padding" : undefined}>
      ...
      <TextInput placeholder="Correo electrónico"placeholderTextColor="#0a0a0a"value={email}onChangeText={setEmail}keyboardType="email-address"autoCapitalize="none"mode="flat" underlineColor="#0d75bb"activeUnderlineColor="#0d75bb"dense contentStyle={{color:"#000",fontWeight:"600"}}style={styles.input}/>
      <TextInput placeholder="Contraseña" placeholderTextColor="#0a0a0a"value={password}onChangeText={setPassword}secureTextEntry={!showPassword}mode="flat" underlineColor="#0d75bb"activeUnderlineColor="#0d75bb"dense contentStyle={{color:"#000",fontWeight:"600"}}style={styles.input}
